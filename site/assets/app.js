...
async function boot(){
  ...
  renderShell();
  document.querySelector('.badge')?.replaceChildren(document.createTextNode('v3.1.0-alpha'));
  show('inicio')
}
...
function toggleTheme(){S.theme=S.theme==='dark'?'light':'dark';document.documentElement.dataset.theme=S.theme;localStorage.setItem('gpa:theme',S.theme);renderShell();document.querySelector('.badge')?.replaceChildren(document.createTextNode('v3.1.0-alpha'));show(S.view)}
